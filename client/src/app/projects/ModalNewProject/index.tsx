...
const ModlalNewProject = ({isOpen,onClose}: Props) => {
    const[createProject,{isLoading}]=useCreateProjectMutation()
    const[projectName,setProjectName]=useState("")
    const[description,setDescritpiton]=useState("")
     ...
     <Modal isOpen={isOpen} onClose={onClose} name="Create New Project">
      ...
      >
        ...
        <textarea
          ...
          value={description}
          onChange={(e) => setDescritpiton(e.target.value)}
        />
...
export default ModlalNewProject